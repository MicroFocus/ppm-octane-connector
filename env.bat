...
REM    Java Root.
REM ####################################################
set ITG_JROOT=C:\Kintana\ppm\SourceCode\java\target\jboss\server\kintana\deploy\itg.war\WEB-INF
set ITG_ROOT=%ITG_JROOT%\..\..

REM ####################################################
REM    ANT Related Environment.
REM ####################################################
set ANT_HOME=C:\Kintana\Build-Tools\ANTs\apache-ant-1.6.2
...
set JDK_LIB_DIR=C:\Kintana\ppm\Utilities\jdk7
