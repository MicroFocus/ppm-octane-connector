...
public class OctaneRootBacklogExternalTask extends BaseOctaneExternalTask {
    ...
    public OctaneRootBacklogExternalTask(List<GenericWorkItem> featuresInBacklog, List<GenericWorkItem> itemsInBacklog, Map<String, List<GenericWorkItem>> featuresItems, WorkplanContext context) {
        ...
        if (itemsInBacklog != null) {
            children.addAll(createBacklogItemsChildrenByType(itemsInBacklog, context));
        }
    }
