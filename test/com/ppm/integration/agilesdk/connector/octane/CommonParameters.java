...
public class CommonParameters {
    ...
    private static ValueSet initValueSet() {
        ...
        values.put(OctaneConstants.KEY_WORKITME_PARENT_ID, "1001");
        values.put(OctaneConstants.KEY_WORKITME_PARENT_TYPE, "work_item_root");
        values.put(OctaneConstants.KEY_PHASE_LOGICNAME_ID, "1019");
        values.put(OctaneConstants.KEY_PHASE_LOGICNAME_TYPE, "phase");
        
        values.put(OctaneConstants.KEY_WORKITME_SUBTYPE, "epic");
